...
function ScreenshotCard({ entry }: { entry: ScreenshotEntry }) {
  ...
  return (
    <div style={{ border: "1px solid hsl(var(--border))", borderRadius: 10, overflow: "hidden", background: "hsl(var(--card))" }}>
      ...
      >
        <span style={{ fontSize: 12, fontWeight: 700, padding: "2px 8px", borderRadius: 20, background: accent.bg, color: accent.text, border: `1px solid ${accent.border}`, textTransform: "uppercase", letterSpacing: "0.05em", flexShrink: 0 }}>
          {isPts ? "PTS" : "Exec"}
        </span>
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 8, alignItems: "center" }}>
          {entry.hasDiff && (
            <span style={{ fontSize: 12, fontWeight: 700, padding: "2px 8px", borderRadius: 20, background: "rgba(239,68,68,0.1)", color: "#ef4444", border: "1px solid rgba(239,68,68,0.25)" }}>
              DIFF
            </span>
          )}
          {expanded
      ...
      {expanded && (
        <div style={{ display: "flex" }}>
          {/* Screenshot image */}
          <div style={{ flex: "0 0 100%", padding: "24px 26px", borderRight: "1px solid hsl(var(--border))", background: "#0d0d0d", display: "flex", alignItems: "flex-start" }}>
